...
| --- | --- | --- |
| [`pydlock-logo.png`](pydlock-logo.png) | Teal serpent + brass hardware on a dark tile | Primary mark — README header, social, anywhere with its own background |
...
All assets are 1254×1254 PNG. The tiled logo is self-contained (its dark tile
reads on both light and dark pages); the mono pair is transparent for
compositing on any surface.
